...
urls = [
    ...
    web.URLSpec(r'/chanllage/view/(\w+)/?', ChanllageViewHandler, name='ChanllageView'),
    web.URLSpec(r'/answer/(\w+)/?', AnswerHandler, name='UploadAnswer'),
    ...
    web.URLSpec(r'/admin/user/(\w+)/(\w+)/?', AdminUserAction, name='AdminUserAction'),
